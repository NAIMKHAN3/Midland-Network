...
const Belive = () => {
    return (
        <div className='max-w-[80%] mt-10 mx-auto p-5 md:p-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 bg-white rounded-xl shadow-sm my-10' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div>
                    <img className='rounded-b-xl md:rounded-r-xl w-full h-full' src={belive} alt="" />
                </div>
            </div>
            <div className='grid grid-cols-1 lg:grid-cols-2 rounded-lg shadow-sm my-10 gap-4'>
                <div className='bg-white rounded-xl shadow-sm' data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className='mt-10'>
                        <img className='w-full h-full' src={passion} alt="" />
                    </div>
                </div>
                <div className='bg-white rounded-xl shadow-sm' data-aos="fade-up" data-aos-duration="1000">
                    <div className='my-5 p-5'>

...
const Help = () => {
    return (
        <div className='max-w-[80%] my-10 mx-auto '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto my-5'>
                <div className=' bg-white rounded-xl row-span-2 shadow-lg' data-aos="fade-right">
                    <div className='p-7'>
                ...
                <div className=' bg-white rounded-xl shadow-lg' data-aos="fade-down" data-aos-duration="1000">
                    <div className='p-7'>
                ...
                <div className='bg-gradient-to-r from-indigo-50 to-pink-100 rounded-xl flex justify-between p-7 shadow-lg' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className=' bg-white rounded-xl flex justify-between shadow-lg' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className=' bg-white rounded-xl flex justify-between p-7 shadow-lg' data-aos="fade-up" data-aos-duration="1000">
                    <div className=' my-auto w-1/2'>

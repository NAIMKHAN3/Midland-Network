...
const Header = () => {
    return (
        ...
        <div className=' bg-cover bg-center lg:h-[650px] w-full  mx-auto my-10 mt-[60px] pt-3' style={{ backgroundImage: `url(${header})` }} data-aos="fade-up" data-aos-duration="1000">

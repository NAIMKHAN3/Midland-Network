...
const StayUpdate = () => {
    return (
        <div className='max-w-[80%] my-10 mx-auto'>
            <h1 className='text-center text-4xl font-semibold'>Stay updated.</h1>
            <p className='text-center text-gray-500 font-semibold mt-3 mb-10'>Discover the latest news</p>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0 my-5' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className='rounded-r-xl'>
                    <img className='rounded-r-xl w-full h-full' src={pay} alt="" />
                </div>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-10'>
                <div className='shadow-lg  rounded-b-xl' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className='shadow-lg bg-gray-700 rounded-xl flex justify-center items-center' data-aos="fade-down" data-aos-duration="1000">
                    <div className=''>
                ...
                <div className='shadow-lg' data-aos="fade-up" data-aos-duration="1000">

            ...
            <div className='max-w-[80%] my-10 mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-5 lg:grid-cols-9 gap-5'>
                    <div className='col-span-3'>
                        ...
                        <p className='text-white my-5 font-semibold'>Midland Networks started life as a business lines and calls provider in Birmingham City Centre, we moved our offices to Halesowen in 2012. We expanded over the following years to cover all forms of business communications and gained customers from all over the UK.</p>
                    ...
                    <div className='col-span-2 text-white'>
                        ...
                        <div className='mt-10 flex'>
                            ...
                            <h1 className='font-semibold'>Midland Networks Group Holdings Ltd,<br /> Commercial House, 21a Stone Street,<br /> Dudley, West Midlands, DY1 1NJ</h1>
                        </div>
                ...
                <h1 className='font-semibold text-center my-3 text-white'>© 2022 Midland Networks Group Holdings Ltd. All Rights Reserved.</h1>
            </div>
        </div>
    );
};
